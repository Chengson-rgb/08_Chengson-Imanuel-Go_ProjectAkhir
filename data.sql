...
CREATE TABLE `data` (
  ...
  `size` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `budget` int NOT NULL,
...
INSERT INTO `data` (`id`, `outfit`, `item`, `size`, `budget`, `purpose`, `material`) VALUES
(14, 'casual', 'Denim Jacket', 'M', 50, 'Travel', 'Linen');
